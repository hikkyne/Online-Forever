...
custom_status_list = [
  "Ooooooooooooooo reeeeeeeeeeeeeee!!! (⁄ ⁄•⁄ω⁄•⁄ ⁄)",
  "Oreoooooooooooooo reeeeeeeeeeeeeee~ >w<",
  "Oooooo... o re... oooooooooreeeee... (つ﹏⊂)",
  "Reeeeeeeeeeeeeeeeeeeee ooooooooooo!! (⌒‿⌒)",
  "Ore? Oooooooooo... reeeeeeeee ;_; (⁄ ⁄•⁄ω⁄•⁄ ⁄)",
  "Reeeeeeeee oooooooooo ore oooooooo~ (≧◡≦)",
  "Ore ore ore ore! (°◡°♡)",
  "O re re re re ~ (⁄ ⁄>⁄ω⁄<⁄ ⁄)",
  "Ore re o re re o re! >///<",
  "Re ore re ore ~ (⌒ω⌒)",
  "O re o re ore ore ^_^ (づ｡◕‿‿◕｡)づ",
  "Ore o re o re o re! >w<",
  "Oreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee!! (((o(*ﾟ▽ﾟ*)o)))",
  "Oooooooooooooooooreeeeeeeeeeeeeeeeeee >w<",
  "Rere rere rereeeeeee oooooooooooo~ (⁄ ⁄•⁄ω⁄•⁄ ⁄)",
  "Oooo reee oooo reee ore reeeee ooooo! ヾ(≧▽≦*)o",
  "Oooooooooooooooooooooooooooooooo reeeeeeeeeeeeeee! (((φ(◎ロ◎;)φ)))",
  "Ore? Re? Oooooooo... reeeeeee... (;´༎ຶД༎ຶ`)",
  "O re o re ooooooo reeeeeee ooooooo reeeee (⁄ ⁄>⁄ω⁄<⁄ ⁄)",
  "Just a lil ooooooooooo reeeeeeeeeeeee for your soul (•́ ͜ʖ •̀)",
  "Ore reeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee!! ooooooo!! (＾◡＾)っ",
  "Reeeeeeeeeeeeeeeeeee ooooooooooooooo ore oreeeee!! (*≧ω≦)",
  "Re re ore re, ore re? (°ロ°)☝",
  "Ore... o re... ore re... ಥ‿ಥ",
  "Re ore o re, ore re re ( ´•̥̥̥ω•̥̥̥` )",
  "Ore re... o re... (つ﹏⊂)",
  "Ore ore, re re, ore o re! (☆▽☆)",
  "O re! Ore? Re re!! >w<",
  "Ore o re ore re o re re! (ﾉ◕ヮ◕)ﾉ*:･ﾟ✧",
  "Re... o re re... ore ore... (｡•́︿•̀｡)",
  "Ore re ore re ore re ore re (⌒‿⌒)",
  "Ooooooooooooore oooooooooooore reeeee~ (*≧▽≦)",
  "Ore ore oreeeeeeeeeeeeeeeeeeeeeee (｡♥‿♥｡)",
  "Ooooooo reee ooooooo reee ooooooo (╯°□°）╯︵ ┻━┻",
  "Reeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee! ヽ(；▽；)ノ",
  "Oooooo reeeee oreeeeeeee~ (灬º‿º灬)",
  "Ore re?! Ore ore re re!! (╯°□°）╯︵ ┻━┻",
  "Re ore re ore... o re! (⁄ ⁄•⁄ω⁄•⁄ ⁄)",
  "Ore, o re, re ore, ore re (°◡°♡)",
  "Re o re o re ore o re o re re!! (ﾉ≧ڡ≦)"
]
# custom_status_list = [
