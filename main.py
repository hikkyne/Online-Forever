...
custom_status_list = [
     "Ooooooooooooooo reeeeeeeeeeeeeee!!!",
    "Oreoooooooooooooo reeeeeeeeeeeeeee~",
    "Oooooo... o re... oooooooooreeeee...",
    "Reeeeeeeeeeeeeeeeeeeee ooooooooooo!!",
    "Ore? Oooooooooo... reeeeeeeee ;_;",
    ...
    "O re o re ore ore ^_^",
    "Ore o re o re o re!",
    "Oreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee!!",
    "Oooooooooooooooooreeeeeeeeeeeeeeeeeee >w<",
    "Rere rere rereeeeeee oooooooooooo~",
    "Oooo reee oooo reee ore reeeee ooooo!",
    "Oooooooooooooooooooooooooooooooo reeeeeeeeeeeeeee! (((φ(◎ロ◎;)φ)))",
    "Ore? Re? Oooooooo... reeeeeee...",
    "O re o re ooooooo reeeeeee ooooooo reeeee",
    "Just a lil ooooooooooo reeeeeeeeeeeee for your soul",
    "Ore reeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee!! ooooooo!!",
    "Reeeeeeeeeeeeeeeeeee ooooooooooooooo ore oreeeee!!",
    "Re re ore re, ore re?",
    "Ore... o re... ore re... ಥ‿ಥ",
    "Re ore o re, ore re re",
    "Ore re... o re... (つ﹏⊂)",
    "Ore ore, re re, ore o re!",
    "O re! Ore? Re re!! >w<",
    "Ore o re ore re o re re!",
    "Re... o re re... ore ore...",
    "Ore re ore re ore re ore re (⌒‿⌒)",
    "Ooooooooooooore oooooooooooore reeeee~",
    "Ore ore oreeeeeeeeeeeeeeeeeeeeeee",
    "Ooooooo reee ooooooo reee ooooooo (╯°□°）╯︵ ┻━┻",
    "Reeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee!",
    "Oooooo reeeee oreeeeeeee~",
    "Ore re?! Ore ore re re!! (╯°□°）╯︵ ┻━┻",
    "Re ore re ore... o re! (⁄ ⁄•⁄ω⁄•⁄ ⁄)",
    "Ore, o re, re ore, ore re (°◡°♡)",
    "Re o re o re ore o re o re re!!"
]
# custom_status_list = [
